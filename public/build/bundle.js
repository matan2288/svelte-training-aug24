...
var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "card svelte-s0muwt");
    ...
    function create_default_slot$1(ctx) {
    	let div;
    	let t0_value = /*fb*/ ctx[0].rating + "";
    	let t0;
    	let t1;
    	let button;
    	let t3;
    	let p;
    	let t4_value = /*fb*/ ctx[0].text + "";
    	let t4;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t4 = text(t4_value);
    			attr_dev(div, "class", "num-display svelte-14sdawg");
    			add_location(div, file$6, 13, 2, 287);
    			attr_dev(button, "class", "close svelte-14sdawg");
    			add_location(button, file$6, 16, 2, 340);
    			attr_dev(p, "class", "text-display");
    			add_location(p, file$6, 17, 2, 411);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*fb*/ 1 && t0_value !== (t0_value = /*fb*/ ctx[0].rating + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*fb*/ 1 && t4_value !== (t4_value = /*fb*/ ctx[0].text + "")) set_data_dev(t4, t4_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	const handleDelete = fbId => {
    		FeedbackStore.update(currentFeedback => {
    			return currentFeedback.filter(fb => fb.id !== fbId);
    		});
    	};

    	$$self.$$.on_mount.push(function () {
    		if (fb === undefined && !('fb' in $$props || $$self.$$.bound[$$self.$$.props['fb']])) {
    			console.warn("<FeedbackItem> was created without expected prop 'fb'");
    		}
    	});

    	const writable_props = ['fb'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<FeedbackItem> was created with unknown prop '${key}'`);
    	});

    	const click_handler = () => handleDelete(fb.id);

    	$$self.$$set = $$props => {
    		if ('fb' in $$props) $$invalidate(0, fb = $$props.fb);
    	};

    	$$self.$capture_state = () => ({ FeedbackStore, Card, fb, handleDelete });
    	...
    	return [fb, handleDelete, click_handler];
    }

    class FeedbackItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { fb: 0 });
    ...
    /* src/Components/FeebackList.svelte generated by Svelte v3.59.2 */
    const file$5 = "src/Components/FeebackList.svelte";
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$5, 19, 2, 478);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*$FeedbackStore*/ 1) feedbackitem_changes.fb = /*fb*/ ctx[3];
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('FeebackList', slots, []);
    	let feedback = [];
    	const unsubscribe = FeedbackStore.subscribe(data => feedback = data);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<FeebackList> was created with unknown prop '${key}'`);
    	});
    ...
    class FeebackList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h40, file$4, 8, 2, 226);
    			add_location(h41, file$4, 9, 2, 253);
    			attr_dev(div, "class", "feedback-stats svelte-ga2qn0");
    			add_location(div, file$4, 7, 0, 195);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "svelte-1jbz7lb");
    			add_location(input0, file$2, 14, 4, 279);
    			attr_dev(label0, "for", "num1");
    			attr_dev(label0, "class", "svelte-1jbz7lb");
    			add_location(label0, file$2, 22, 4, 426);
    			attr_dev(li0, "class", "svelte-1jbz7lb");
    			add_location(li0, file$2, 13, 2, 270);
    			attr_dev(input1, "type", "radio");
    			attr_dev(input1, "id", "num2");
    			attr_dev(input1, "name", "rating");
    			input1.value = "2";
    			input1.checked = input1_checked_value = /*selected*/ ctx[0] === 2;
    			attr_dev(input1, "class", "svelte-1jbz7lb");
    			add_location(input1, file$2, 25, 4, 473);
    			attr_dev(label1, "for", "num2");
    			attr_dev(label1, "class", "svelte-1jbz7lb");
    			add_location(label1, file$2, 33, 4, 620);
    			attr_dev(li1, "class", "svelte-1jbz7lb");
    			add_location(li1, file$2, 24, 2, 464);
    			attr_dev(input2, "type", "radio");
    			attr_dev(input2, "id", "num3");
    			attr_dev(input2, "name", "rating");
    			input2.value = "3";
    			input2.checked = input2_checked_value = /*selected*/ ctx[0] === 3;
    			attr_dev(input2, "class", "svelte-1jbz7lb");
    			add_location(input2, file$2, 36, 4, 667);
    			attr_dev(label2, "for", "num3");
    			attr_dev(label2, "class", "svelte-1jbz7lb");
    			add_location(label2, file$2, 44, 4, 814);
    			attr_dev(li2, "class", "svelte-1jbz7lb");
    			add_location(li2, file$2, 35, 2, 658);
    			attr_dev(input3, "type", "radio");
    			attr_dev(input3, "id", "num4");
    			attr_dev(input3, "name", "rating");
    			input3.value = "4";
    			input3.checked = input3_checked_value = /*selected*/ ctx[0] === 4;
    			attr_dev(input3, "class", "svelte-1jbz7lb");
    			add_location(input3, file$2, 47, 4, 861);
    			attr_dev(label3, "for", "num4");
    			attr_dev(label3, "class", "svelte-1jbz7lb");
    			add_location(label3, file$2, 55, 4, 1008);
    			attr_dev(li3, "class", "svelte-1jbz7lb");
    			add_location(li3, file$2, 46, 2, 852);
    			attr_dev(input4, "type", "radio");
    			attr_dev(input4, "id", "num5");
    			attr_dev(input4, "name", "rating");
    			input4.value = "5";
    			input4.checked = input4_checked_value = /*selected*/ ctx[0] === 5;
    			attr_dev(input4, "class", "svelte-1jbz7lb");
    			add_location(input4, file$2, 58, 4, 1055);
    			attr_dev(label4, "for", "num5");
    			attr_dev(label4, "class", "svelte-1jbz7lb");
    			add_location(label4, file$2, 66, 4, 1202);
    			attr_dev(li4, "class", "svelte-1jbz7lb");
    			add_location(li4, file$2, 57, 2, 1046);
    			attr_dev(input5, "type", "radio");
    			attr_dev(input5, "id", "num6");
    			attr_dev(input5, "name", "rating");
    			input5.value = "6";
    			input5.checked = input5_checked_value = /*selected*/ ctx[0] === 6;
    			attr_dev(input5, "class", "svelte-1jbz7lb");
    			add_location(input5, file$2, 69, 4, 1249);
    			attr_dev(label5, "for", "num6");
    			attr_dev(label5, "class", "svelte-1jbz7lb");
    			add_location(label5, file$2, 77, 4, 1396);
    			attr_dev(li5, "class", "svelte-1jbz7lb");
    			add_location(li5, file$2, 68, 2, 1240);
    			attr_dev(input6, "type", "radio");
    			attr_dev(input6, "id", "num7");
    			attr_dev(input6, "name", "rating");
    			input6.value = "7";
    			input6.checked = input6_checked_value = /*selected*/ ctx[0] === 7;
    			attr_dev(input6, "class", "svelte-1jbz7lb");
    			add_location(input6, file$2, 80, 4, 1443);
    			attr_dev(label6, "for", "num7");
    			attr_dev(label6, "class", "svelte-1jbz7lb");
    			add_location(label6, file$2, 88, 4, 1590);
    			attr_dev(li6, "class", "svelte-1jbz7lb");
    			add_location(li6, file$2, 79, 2, 1434);
    			...
    			attr_dev(input7, "class", "svelte-1jbz7lb");
    			add_location(input7, file$2, 91, 4, 1637);
    			attr_dev(label7, "for", "num8");
    			attr_dev(label7, "class", "svelte-1jbz7lb");
    			add_location(label7, file$2, 99, 4, 1784);
    			attr_dev(li7, "class", "svelte-1jbz7lb");
    			add_location(li7, file$2, 90, 2, 1628);
    			...
    			attr_dev(input8, "class", "svelte-1jbz7lb");
    			add_location(input8, file$2, 102, 4, 1831);
    			attr_dev(label8, "for", "num9");
    			attr_dev(label8, "class", "svelte-1jbz7lb");
    			add_location(label8, file$2, 110, 4, 1978);
    			attr_dev(li8, "class", "svelte-1jbz7lb");
    			add_location(li8, file$2, 101, 2, 1822);
    			...
    			attr_dev(input9, "class", "svelte-1jbz7lb");
    			add_location(input9, file$2, 113, 4, 2025);
    			attr_dev(label9, "for", "num10");
    			attr_dev(label9, "class", "svelte-1jbz7lb");
    			add_location(label9, file$2, 121, 4, 2175);
    			attr_dev(li9, "class", "svelte-1jbz7lb");
    			add_location(li9, file$2, 112, 2, 2016);
    			attr_dev(ul, "class", "rating svelte-1jbz7lb");
    			add_location(ul, file$2, 12, 0, 248);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (58:6) <Button disabled={btnDisabled} type="submit">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(58:6) <Button disabled={btnDisabled} type=\\\"submit\\\">",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "message svelte-x0ty0b");
    			add_location(div, file$1, 60, 4, 1401);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-x0ty0b");
    			add_location(h2, file$1, 46, 4, 943);
    			attr_dev(header, "class", "svelte-x0ty0b");
    			add_location(header, file$1, 45, 2, 930);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Tell us something that keeps you coming back");
    			attr_dev(input, "class", "svelte-x0ty0b");
    			add_location(input, file$1, 51, 6, 1143);
    			attr_dev(div, "class", "input-group svelte-x0ty0b");
    			add_location(div, file$1, 50, 4, 1111);
    			add_location(form, file$1, 48, 2, 1007);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	feedbacklist = new FeebackList({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 6, 0, 209);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
